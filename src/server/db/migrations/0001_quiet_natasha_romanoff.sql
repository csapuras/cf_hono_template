...
CREATE TABLE `__new_subscribers` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-07-07T06:38:53.272Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-07T06:38:53.272Z"' NOT NULL,
	`traffic_source` text,
	`device` text,
	`email_verified` integer,
	`unsubscribed` integer,
	`confirmation_token` text,
	CONSTRAINT "email" CHECK("__new_subscribers"."email" LIKE '%@%.%')
);
